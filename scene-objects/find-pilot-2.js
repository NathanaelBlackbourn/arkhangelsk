...
const findPilot2 = {
    ...
    nielsenThoughts:'I read about something like this in inuit mythology. We must learn how it is keeping that tree alive.',
    kleistThoughts:'If there are more of these things in this crater, we need to find them. We need to… go to the centre.',
    overgaardThoughts:'When we leave this hell you will all sign non-disclosure agreements. This is property of the company. We must keep it safe.',
    return() {
