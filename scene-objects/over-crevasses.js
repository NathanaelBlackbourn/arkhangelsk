...
const overCrevasses = {
    ...
    kleistThoughts:'No data is worth a human life, we have to do what we can to get them back to safety.',
    overgaardThoughts:'Taking them with us will slow us down so much that we might not even make it out of here ourselves. It’s a grim decision but I say we leave them.',
    bringThem() {
