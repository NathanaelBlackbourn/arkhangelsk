...
const waitTheStormOut = {
    ...
    nielsenThoughts:'You have no time to talk with your teammates. You must act now.',
    kleistThoughts:'You have no time to talk with your teammates. You must act now.',
    overgaardThoughts:'You have no time to talk with your teammates. You must act now.',
    throwSomeFood() {
        food = food - 1;
        showFood();
